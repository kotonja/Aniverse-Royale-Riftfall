# Aniverse Royale: Riftfall Game Bible
...
Original anime-inspired Roblox squad battle royale.
...
- Aura Arts: original character power system.
- Aura Link: future squad combo effects.
...
- Global matchmaking through MemoryStore queues.
- Reserved match servers.
- Ranked.
- Leaderboards.
- Battle pass.
- Cosmetics.
- Full battle royale map.
- Riftstorm phases.
- Loot modules.
...
Everything in this project must stay original. Do not use copyrighted anime characters, outfit silhouettes, logos, move names, music, sounds, UI, terms, or references. Do not use protected or franchise-specific words from existing anime/game IP.
